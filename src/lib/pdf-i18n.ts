...
export interface PdfStrings {
  ...
  a4: { banner: string; empty: string; titleSing: string; titlePlur: string; headers: string[]; aeDetail: string; aeHeaders: string[]; operateurs: Record<string, string>; methodeLabel: string; methodes: Record<string, string> }
  a5: {
...
const fr: PdfStrings = {
  ...
  a4: { banner: 'ATELIER 4 — SCÉNARIOS OPÉRATIONNELS', empty: 'Aucun scénario opérationnel défini dans cette analyse.', titleSing: 'Scénario opérationnel', titlePlur: 'Scénarios opérationnels', headers: ['Scénario opérationnel', 'Scénario stratégique', 'Vraisemblance', 'Gravité', 'Score'], aeDetail: 'Détail des actions élémentaires', aeHeaders: ['Op.', 'Action élémentaire', 'Type', 'Bien support', 'Vulnérabilité'], operateurs: { ET: 'ET', OU: 'OU' }, methodeLabel: 'Méthode de vraisemblance', methodes: { EXPRESSE: 'Expresse', STANDARD: 'Standard', AVANCEE: 'Avancée' } },
  a5: {
...
const en: PdfStrings = {
  ...
  a4: { banner: 'WORKSHOP 4 — OPERATIONAL SCENARIOS', empty: 'No operational scenario defined in this analysis.', titleSing: 'Operational scenario', titlePlur: 'Operational scenarios', headers: ['Operational scenario', 'Strategic scenario', 'Likelihood', 'Severity', 'Score'], aeDetail: 'Elementary actions detail', aeHeaders: ['Op.', 'Elementary action', 'Type', 'Supporting asset', 'Vulnerability'], operateurs: { ET: 'AND', OU: 'OR' }, methodeLabel: 'Likelihood method', methodes: { EXPRESSE: 'Express', STANDARD: 'Standard', AVANCEE: 'Advanced' } },
  a5: {
...
const de: PdfStrings = {
  ...
  a4: { banner: 'WORKSHOP 4 — OPERATIVE SZENARIEN', empty: 'Kein operatives Szenario in dieser Analyse definiert.', titleSing: 'Operatives Szenario', titlePlur: 'Operative Szenarien', headers: ['Operatives Szenario', 'Strategisches Szenario', 'Wahrscheinlichkeit', 'Schweregrad', 'Wert'], aeDetail: 'Detail der Elementaraktionen', aeHeaders: ['Op.', 'Elementaraktion', 'Typ', 'Unterstützendes Asset', 'Schwachstelle'], operateurs: { ET: 'UND', OU: 'ODER' }, methodeLabel: 'Wahrscheinlichkeitsmethode', methodes: { EXPRESSE: 'Express', STANDARD: 'Standard', AVANCEE: 'Erweitert' } },
  a5: {
...
const es: PdfStrings = {
  ...
  a4: { banner: 'TALLER 4 — ESCENARIOS OPERATIVOS', empty: 'Ningún escenario operativo definido en este análisis.', titleSing: 'Escenario operativo', titlePlur: 'Escenarios operativos', headers: ['Escenario operativo', 'Escenario estratégico', 'Verosimilitud', 'Gravedad', 'Puntuación'], aeDetail: 'Detalle de las acciones elementales', aeHeaders: ['Op.', 'Acción elemental', 'Tipo', 'Activo de soporte', 'Vulnerabilidad'], operateurs: { ET: 'Y', OU: 'O' }, methodeLabel: 'Método de probabilidad', methodes: { EXPRESSE: 'Exprés', STANDARD: 'Estándar', AVANCEE: 'Avanzado' } },
  a5: {
...
const it: PdfStrings = {
  ...
  a4: { banner: 'WORKSHOP 4 — SCENARI OPERATIVI', empty: 'Nessuno scenario operativo definito in questa analisi.', titleSing: 'Scenario operativo', titlePlur: 'Scenari operativi', headers: ['Scenario operativo', 'Scenario strategico', 'Verosimiglianza', 'Gravità', 'Punteggio'], aeDetail: 'Dettaglio delle azioni elementari', aeHeaders: ['Op.', 'Azione elementare', 'Tipo', 'Asset di supporto', 'Vulnerabilità'], operateurs: { ET: 'E', OU: 'O' }, methodeLabel: 'Metodo di verosimiglianza', methodes: { EXPRESSE: 'Espresso', STANDARD: 'Standard', AVANCEE: 'Avanzato' } },
  a5: {
