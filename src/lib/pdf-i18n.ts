...
export interface PdfStrings {
  ...
  a4: { banner: string; empty: string; titleSing: string; titlePlur: string; headers: string[]; aeDetail: string; aeHeaders: string[]; operateurs: Record<string, string> }
  a5: {
...
const en: PdfStrings = {
  ...
  a4: { banner: 'WORKSHOP 4 — OPERATIONAL SCENARIOS', empty: 'No operational scenario defined in this analysis.', titleSing: 'Operational scenario', titlePlur: 'Operational scenarios', headers: ['Operational scenario', 'Strategic scenario', 'Likelihood', 'Severity', 'Score'], aeDetail: 'Elementary actions detail', aeHeaders: ['Op.', 'Elementary action', 'Type', 'Supporting asset', 'Vulnerability'], operateurs: { ET: 'AND', OU: 'OR' } },
  a5: {
...
const de: PdfStrings = {
  ...
  a4: { banner: 'WORKSHOP 4 — OPERATIVE SZENARIEN', empty: 'Kein operatives Szenario in dieser Analyse definiert.', titleSing: 'Operatives Szenario', titlePlur: 'Operative Szenarien', headers: ['Operatives Szenario', 'Strategisches Szenario', 'Wahrscheinlichkeit', 'Schweregrad', 'Wert'], aeDetail: 'Detail der Elementaraktionen', aeHeaders: ['Op.', 'Elementaraktion', 'Typ', 'Unterstützendes Asset', 'Schwachstelle'], operateurs: { ET: 'UND', OU: 'ODER' } },
  a5: {
