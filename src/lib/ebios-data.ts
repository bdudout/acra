...
export const DORA_CONTROLES: FrameworkControl[] = [
  // ── Pilier 1 — Gestion du risque ICT (chapitre II, art. 5-16) ──────────────
  { ref:'DORA-ICT-1', type:'ORGANISATIONNELLE', categorie:'ICT', nom:'Gouvernance et responsabilité de l\'organe de direction', description:'L\'organe de direction définit, approuve, supervise et répond de la mise en œuvre du cadre de gestion du risque ICT ; il alloue les budgets adéquats, se forme et intègre le risque ICT à sa stratégie (art. 5).' },
  { ref:'DORA-ICT-2', type:'ORGANISATIONNELLE', categorie:'ICT', nom:'Cadre de gestion du risque ICT documenté', description:'Un cadre de gestion du risque ICT et une stratégie de résilience opérationnelle numérique sont documentés, revus au moins annuellement et après tout incident majeur (art. 6).' },
  { ref:'DORA-ICT-3', type:'ORGANISATIONNELLE', categorie:'ICT', nom:'Audit indépendant du cadre de risque ICT', description:'Le cadre de gestion du risque ICT est audité périodiquement par des auditeurs indépendants disposant des compétences ICT requises, avec suivi formel des recommandations (art. 6, §6-7).' },
  { ref:'DORA-ICT-4', type:'TECHNOLOGIQUE',    categorie:'ICT', nom:'Systèmes, protocoles et outils ICT adéquats', description:'Les systèmes, protocoles et outils ICT sont fiables, dotés d\'une capacité suffisante, technologiquement résilients et adaptés à l\'intensité des opérations (art. 7).' },
  { ref:'DORA-ICT-5', type:'ORGANISATIONNELLE', categorie:'ICT', nom:'Identification et cartographie des fonctions et actifs ICT', description:'Les fonctions critiques ou importantes, les actifs d\'information et actifs ICT qui les supportent, ainsi que leurs interdépendances, sont identifiés, classés et tenus à jour (art. 8, §1-4).' },
  { ref:'DORA-ICT-6', type:'ORGANISATIONNELLE', categorie:'ICT', nom:'Évaluation continue des sources de risque ICT', description:'Le risque ICT est évalué en continu, ainsi qu\'à l\'occasion de tout changement majeur d\'infrastructure ou de processus ; les sources de risque et les cybermenaces sont documentées (art. 8, §5-7).' },
  { ref:'DORA-ICT-7', type:'TECHNOLOGIQUE',    categorie:'ICT', nom:'Protection et prévention — politiques de sécurité', description:'Des politiques, procédures et outils de sécurité ICT garantissent la résilience, la disponibilité, l\'authenticité, l\'intégrité et la confidentialité des données et des systèmes (art. 9, §1-3).' },
  { ref:'DORA-ICT-8', type:'TECHNOLOGIQUE',    categorie:'ICT', nom:'Gestion des identités, des accès et des droits', description:'Une gestion stricte des identités et des accès applique le moindre privilège, la séparation des tâches et le contrôle des accès physiques et logiques aux actifs ICT (art. 9, §4).' },
  ...
  { ref:'DORA-ICT-10', type:'TECHNOLOGIQUE',   categorie:'ICT', nom:'Gestion des changements et des correctifs ICT', description:'Des procédures de gestion des changements et des correctifs (patchs) encadrent les évolutions matérielles et logicielles, avec tests, validation et journalisation (art. 9, §4).' },
  { ref:'DORA-ICT-11', type:'TECHNOLOGIQUE',   categorie:'ICT', nom:'Détection des activités anormales', description:'Des mécanismes multi-couches détectent rapidement les anomalies, les incidents ICT et les points de défaillance uniques, avec seuils d\'alerte et procédures de remontée (art. 10).' },
  { ref:'DORA-ICT-12', type:'ORGANISATIONNELLE', categorie:'ICT', nom:'Politique de continuité d\'activité ICT', description:'Une politique de continuité d\'activité ICT et des plans de réponse et de rétablissement fixent des objectifs de temps (RTO) et de point (RPO) de reprise pour les fonctions critiques (art. 11, §1-4).' },
  { ref:'DORA-ICT-13', type:'TECHNOLOGIQUE',   categorie:'ICT', nom:'Tests des plans de continuité et de rétablissement', description:'Les plans de continuité et de rétablissement ICT sont testés au moins une fois par an et après changement majeur, y compris les scénarios de bascule vers les capacités redondantes (art. 11, §6).' },
  { ref:'DORA-ICT-14', type:'ORGANISATIONNELLE', categorie:'ICT', nom:'Cellule de gestion de crise ICT', description:'Une fonction ou cellule de gestion de crise coordonne la réponse aux incidents ICT majeurs et la communication interne et externe associée (art. 11, §7).' },
  ...
  { ref:'DORA-ICT-16', type:'ORGANISATIONNELLE', categorie:'ICT', nom:'Apprentissage et amélioration continue', description:'Des revues post-incident, la veille sur les menaces et l\'analyse des tests alimentent l\'amélioration continue du cadre de risque ICT (art. 13, §1-5).' },
  ...
  { ref:'DORA-ICT-19', type:'ORGANISATIONNELLE', categorie:'ICT', nom:'Cadre simplifié de gestion du risque ICT (entités éligibles)', description:'Les entités éligibles (petites, non interconnectées) appliquent un cadre simplifié de gestion du risque ICT proportionné, couvrant protection, détection, continuité et revues (art. 16).' },

  // ── Pilier 2 — Gestion, classification et notification des incidents (chap. III, art. 17-23) ──
  { ref:'DORA-INC-1', type:'ORGANISATIONNELLE', categorie:'INC', nom:'Processus de gestion des incidents liés aux ICT', description:'Un processus documenté détecte, gère, journalise et remonte les incidents liés aux ICT, avec rôles, indicateurs d\'alerte précoce et procédures d\'escalade (art. 17).' },
  ...
  { ref:'DORA-INC-3', type:'ORGANISATIONNELLE', categorie:'INC', nom:'Notification des incidents majeurs à l\'autorité compétente', description:'Les incidents majeurs liés aux ICT sont notifiés à l\'autorité compétente dans les délais réglementaires via les notifications initiale, intermédiaire et finale (art. 19, §1 et §4).' },
  ...
  { ref:'DORA-TEST-1', type:'ORGANISATIONNELLE', categorie:'TEST', nom:'Programme de tests de résilience opérationnelle', description:'Un programme de tests, fondé sur le risque et proportionné, est établi et intégré au cadre de gestion du risque ICT (art. 24).' },
  ...
  { ref:'DORA-TEST-3', type:'TECHNOLOGIQUE',   categorie:'TEST', nom:'Tests des outils et systèmes ICT', description:'Une batterie de tests (analyses de vulnérabilités, scans, analyses d\'écarts, revues de sécurité physique, revues de code, tests de scénarios et de pénétration) est menée au moins annuellement sur les systèmes supportant les fonctions critiques (art. 25).' },
  { ref:'DORA-TEST-4', type:'TECHNOLOGIQUE',   categorie:'TEST', nom:'Tests de pénétration fondés sur la menace (TLPT)', description:'Les entités désignées réalisent des tests de pénétration fondés sur la menace (TLPT, cadre TIBER-EU) au moins tous les 3 ans, couvrant les fonctions critiques et incluant les prestataires ICT concernés (art. 26).' },
  ...
  // ── Pilier 4 — Gestion du risque lié aux prestataires tiers ICT (chap. V, art. 28-30) ──
  { ref:'DORA-TPP-1', type:'ORGANISATIONNELLE', categorie:'TPP', nom:'Stratégie de gestion du risque prestataires ICT', description:'La gestion du risque lié aux prestataires ICT fait partie intégrante du cadre de risque ICT ; une stratégie, incluant une politique d\'usage des services supportant des fonctions critiques, est adoptée et revue (art. 28, §1-2).' },
  { ref:'DORA-TPP-2', type:'ORGANISATIONNELLE', categorie:'TPP', nom:'Registre d\'information des accords ICT', description:'Un registre d\'information recense tous les accords contractuels avec les prestataires ICT (en distinguant ceux qui soutiennent des fonctions critiques) ; il est tenu à jour et communiqué aux autorités, qui sont informées des nouveaux accords critiques (art. 28, §3).' },
  { ref:'DORA-TPP-3', type:'ORGANISATIONNELLE', categorie:'TPP', nom:'Due diligence avant contractualisation ICT', description:'Une évaluation préalable (due diligence) du prestataire et du risque associé est menée avant tout contrat ICT, en particulier pour les fonctions critiques ou importantes, incluant sous-traitance et risque de concentration (art. 28, §4-6).' },
  { ref:'DORA-TPP-4', type:'ORGANISATIONNELLE', categorie:'TPP', nom:'Stratégies de sortie des prestataires critiques', description:'Des stratégies de sortie et des plans de transition documentés et testés sont définis pour les services ICT soutenant des fonctions critiques ou importantes (art. 28, §8).' },
  { ref:'DORA-TPP-5', type:'ORGANISATIONNELLE', categorie:'TPP', nom:'Évaluation du risque de concentration ICT', description:'Le risque de concentration au niveau de l\'entité est évalué, y compris en cas de sous-traitance en cascade ou de dépendance à un prestataire difficilement substituable (art. 29).' },
  { ref:'DORA-TPP-6', type:'ORGANISATIONNELLE', categorie:'TPP', nom:'Clauses contractuelles essentielles (tous services)', description:'Les contrats ICT comportent a minima : description des services, localisation des données et du traitement, protection des données, niveaux de service, assistance en cas d\'incident, droits de résiliation (art. 30, §2).' },
  ...
  { ref:'DORA-TPP-8', type:'ORGANISATIONNELLE', categorie:'TPP', nom:'Suivi des prestataires ICT critiques et de leur sous-traitance', description:'L\'entité tient compte de la désignation des prestataires ICT critiques et du cadre de supervision associé, et surveille la chaîne de sous-traitance des services soutenant des fonctions critiques (art. 28-31).' },
