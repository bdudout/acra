...
export default function Atelier2({ analyseId, initialData, analyse, flashMode }: Props) {
  ...
  function addSource(exemple?: any) {
    ...
    setSources(prev => [...prev, {
      ...
      activite: exemple?.activite || '',
      motivationScore: exemple?.motivationScoreDefaut ?? 2,
      ressourcesScore: exemple?.ressourcesScoreDefaut ?? 2,
      activiteScore: exemple?.activiteScoreDefaut ?? 2,
